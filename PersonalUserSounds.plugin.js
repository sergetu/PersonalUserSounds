...
(function (global) {
    ...
    PussUI.prototype.openUserModal = function (payload) {
        ...
        var modeHelp = body.querySelector('[data-role="mode-help"]');
        if (modeHelp) {
            ...
            for (var h = 0; h < keys.length; h++) {
                ...
                rowEl.className = "puss-mode-help-row";
                var nameEl = document.createElement("span");
                nameEl.className = "puss-mode-help-name";
                nameEl.textContent = this.text(keys[h][0]);
                var descEl = document.createElement("span");
                descEl.className = "puss-mode-help-desc";
                descEl.textContent = this.text(keys[h][1]);
                rowEl.appendChild(nameEl);
                rowEl.appendChild(descEl);
                modeHelp.appendChild(rowEl);
            }
        }
